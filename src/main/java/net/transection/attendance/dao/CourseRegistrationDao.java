...
//DEMO
	@Query("SELECT s FROM IyfCoureRegTrn s JOIN s.objGbltOtpStudentRegTrns where s.mICourseConfig =:mICourseConfig  and s.mIsValid = 1 and s.mStOrgId =:org and s.objGbltOtpStudentRegTrns.IIsValid=1 ")  
